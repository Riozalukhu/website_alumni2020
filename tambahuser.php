                          ...
                          <form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="info">
                             <div class="row">
                                    ...
                                    <label for="exampleFormControlInput1"></label>
                                    <input type="text" class="form-control" name="id" id="exampleFormControlInput1" placeholder="masukkan id ">
                                    <label for="exampleFormControlInput1"></label>
                                    <input type="text" class="form-control" name="alamat" id="exampleFormControlInput2" placeholder="masukkan alamat ">
                                    <label for="exampleFormControlInput1"></label>
                                    <input type="text" class="form-control" name="pekerjaan" id="exampleFormControlInput2" placeholder="masukkan pekerjaan ">
                                     <label for="exampleFormControlInput1"></label>
                                    <input type="text" class="form-control" name="kontak" id="exampleFormControlInput2" placeholder="masukkan kontak ">
                                  </div>
                                  <div class="form-group">
